...
const eventSchema = new mongoose.Schema(
  {
    ...
    horaFin: { type: String, required: [true, 'La hora de fin es requerida'] },
    espacio: { type: String, required: [true, 'El espacio es requerido'], trim: true },
    parkId: { type: String, required: [true, 'El parkId es requerido'] },
...
module.exports = mongoose.model('Event', eventSchema, 'eventos');
